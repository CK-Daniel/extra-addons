...
jQuery( function( $ ) {
	...
	$(".wc-pao-addon-container .wc-pao-addon-name").on("click", function(){
		var cont = $(this).closest(".wc-pao-addon-container");
		if(cont.find(".form-row-image").length) {
			cont.find(".form-row-image").slideToggle();
		}
	});
	
	$(".wc-pao-addon-image-swatch").on("click", function(){
		var cont = $(this).closest(".wc-pao-addon-container");
		cont.find(".form-row-image").slideUp();
		console.log("slideUp");
	});
