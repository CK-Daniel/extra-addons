...
$addon_type_formatted            = ! empty( $addon_type ) ? $this->convert_type_name( $addon_type ) : __( 'Multiple choice', 'woocommerce-product-addons-extra-digital' );
...
<div class="wc-pao-addon closed">
	<div class="wc-pao-addon-header">
		...
		<div class="wc-pao-col2">
			<button type="button" class="wc-pao-remove-addon button"><?php esc_html_e( 'Remove', 'woocommerce-product-addons-extra-digital' ); ?></button>
			<span class="wc-pao-addon-toggle" title="<?php esc_attr_e( 'Click to toggle', 'woocommerce-product-addons-extra-digital' ); ?>" aria-hidden="true"></span>
	...
	<div class="wc-pao-addon-content">
		<div class="wc-pao-addon-main-settings-1">
			<div class="wc-pao-col1">
				<label for="wc-pao-addon-content-type-<?php echo esc_attr( $loop ); ?>">
					<?php
						esc_html_e( 'Type', 'woocommerce-product-addons-extra-digital' );
					?>
				</label>
				<select id="wc-pao-addon-content-type-<?php echo esc_attr( $loop ); ?>" name="product_addon_type[<?php echo esc_attr( $loop ); ?>]" class="wc-pao-addon-type-select">
					<option <?php selected( 'multiple_choice', $addon_type ); ?> value="multiple_choice"><?php esc_html_e( 'Multiple Choice', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'checkbox', $addon_type ); ?> value="checkbox"><?php esc_html_e( 'Checkboxes', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'custom_text', $addon_type ); ?> value="custom_text"><?php esc_html_e( 'Short Text', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'custom_textarea', $addon_type ); ?> value="custom_textarea"><?php esc_html_e( 'Long Text', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'file_upload', $addon_type ); ?> value="file_upload"><?php esc_html_e( 'File Upload', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'custom_price', $addon_type ); ?> value="custom_price"><?php esc_html_e( 'Customer Defined Price', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'input_multiplier', $addon_type ); ?> value="input_multiplier"><?php esc_html_e( 'Quantity', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'heading', $addon_type ); ?> value="heading"><?php esc_html_e( 'Heading', 'woocommerce-product-addons-extra-digital' ); ?></option>
				</select>
			</div>
			...
			<div class="wc-pao-col2-1  <?php echo esc_attr( $display_display_col ); ?>">
				<label for="wc-pao-addon-content-display-<?php echo esc_attr( $loop ); ?>">
					<?php
						esc_html_e( 'Display as', 'woocommerce-product-addons-extra-digital' );
					?>
				</label>
				<select id="wc-pao-addon-content-display-<?php echo esc_attr( $loop ); ?>" name="product_addon_display[<?php echo esc_attr( $loop ); ?>]" class="wc-pao-addon-display-select">
					<option <?php selected( 'select', $display ); ?> value="select"><?php esc_html_e( 'Dropdowns', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'radiobutton', $display ); ?> value="radiobutton"><?php esc_html_e( 'Radio Buttons', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'images', $display ); ?> value="images"><?php esc_html_e( 'Images', 'woocommerce-product-addons-extra-digital' ); ?></option>
				</select>
			</div>
			...
			<div class="wc-pao-col2-2  <?php echo esc_attr( $display_restrictions_select_col ); ?>">
				<label for="wc-pao-addon-content-restriction-<?php echo esc_attr( $loop ); ?>">
					<?php
						esc_html_e( 'Restriction', 'woocommerce-product-addons-extra-digital' );
					?>
				</label>
				<select id="wc-pao-addon-content-restriction-<?php echo esc_attr( $loop ); ?>" name="product_addon_restrictions_type[<?php echo esc_attr( $loop ); ?>]" class="wc-pao-addon-restrictions-select">
					<option <?php selected( 'any_text', $restrictions_type ); ?> value="any_text"><?php esc_html_e( 'Any Text', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'only_letters', $restrictions_type ); ?> value="only_letters"><?php esc_html_e( 'Only Letters', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'only_numbers', $restrictions_type ); ?> value="only_numbers"><?php esc_html_e( 'Only Numbers', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'only_letters_numbers', $restrictions_type ); ?> value="only_letters_numbers"><?php esc_html_e( 'Only Letters and Numbers', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'email', $restrictions_type ); ?> value="email"><?php esc_html_e( 'Only Email Address', 'woocommerce-product-addons-extra-digital' ); ?></option>
				</select>
			</div>
		</div>
		...
		<div class="wc-pao-addon-main-settings-2">
			<div class="wc-pao-col1">
				<div class="wc-pao-addon-title">
					<label for="wc-pao-addon-content-name-<?php echo esc_attr( $loop ); ?>">
						<?php esc_html_e( 'Title', 'woocommerce-product-addons-extra-digital' ); ?>
					</label>
			...
			<div class="wc-pao-col2 <?php echo esc_attr( $show_heading_col ); ?>">
				<label for="wc-pao-addon-content-title-format-<?php echo esc_attr( $loop ); ?>">
					<?php
						esc_html_e( 'Format title', 'woocommerce-product-addons-extra-digital' );
					?>
				</label>
				<select id="wc-pao-addon-content-title-format" name="product_addon_title_format[<?php echo esc_attr( $loop ); ?>]">
					<option <?php selected( 'label', $title_format ); ?> value="label"><?php esc_html_e( 'Label', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'heading', $title_format ); ?> value="heading"><?php esc_html_e( 'Heading', 'woocommerce-product-addons-extra-digital' ); ?></option>
					<option <?php selected( 'hide', $title_format ); ?> value="hide"><?php esc_html_e( 'Hide', 'woocommerce-product-addons-extra-digital' ); ?></option>
				</select>
			</div>
		</div>
		...
		<div class="wc-pao-addons-secondary-settings">
			<div class="wc-pao-row wc-pao-addon-description-setting">
				<label for="wc-pao-addon-description-enable-<?php echo esc_attr( $loop ); ?>">
					...
					<?php
						esc_html_e( 'Add description', 'woocommerce-product-addons-extra-digital' );
			...
			<div class="wc-pao-row wc-pao-addon-required-setting <?php echo esc_attr( $display_required_setting_class ); ?>">
				<label for="wc-pao-addon-required-<?php echo esc_attr( $loop ); ?>">
					...
					<?php esc_html_e( 'Required field', 'woocommerce-product-addons-extra-digital' ); ?>
				</label>
			</div>
		</div>
			...
			<div class="wc-pao-addon-content-option-inner">
				<div class="wc-pao-addon-content-headers">
					<div class="wc-pao-addon-content-option-header">
						<?php esc_html_e( 'Option', 'woocommerce-product-addons-extra-digital' ); ?>
					</div>

					<div class="wc-pao-addon-content-price-header">
						<div class="wc-pao-addon-content-price-wrap">
							<?php esc_html_e( 'Price', 'woocommerce-product-addons-extra-digital' ); ?>
							<?php echo wc_help_tip( __( 'Choose how to calculate price: apply a flat fee regardless of quantity, charge per quantity ordered, or charge a percentage of the total', 'woocommerce-product-addons-extra-digital' ) ); ?>
						</div>
					</div>
				...
				<div class="wc-pao-addon-content-footer">
					<button type="button" class="wc-pao-add-option button"><?php esc_html_e( 'Add Option', 'woocommerce-product-addons-extra-digital' ); ?></button>
				</div>
			</div>
		</div>
		...
		$restriction_name            = __( 'Restrictions', 'woocommerce-product-addons-extra-digital' );
		switch ( $addon_type ) {
			case 'checkbox':
				$display_adjust_price = 'hide';
				break;
			case 'custom_price':
				$restriction_name = __( 'Limit price range', 'woocommerce-product-addons-extra-digital' );
				$display_adjust_price = 'hide';
				break;
			case 'input_multiplier':
				$restriction_name = __( 'Limit quantity range', 'woocommerce-product-addons-extra-digital' );
				break;
			case 'custom_text':
				$restriction_name = __( 'Limit character length', 'woocommerce-product-addons-extra-digital' );
				break;
		...
		<div class="wc-pao-addon-content-non-option-rows <?php echo esc_attr( $display_non_option_rows_class ); ?>">
			<div class="wc-pao-row wc-pao-addon-restrictions-container <?php echo esc_attr( $display_restrictions ); ?>">
				...
				<div class="wc-pao-addon-restrictions-settings <?php echo esc_attr( $display_restrictions_settings ); ?>">
					<div class="wc-pao-addon-min-max <?php echo esc_attr( $display_min_max ); ?>">
						...
						<input type="number" name="product_addon_max[<?php echo esc_attr( $loop ); ?>]" value="<?php echo esc_attr( $max ); ?>" placeholder="<?php esc_attr_e( 'unlimited', 'woocommerce-product-addons-extra-digital' ) ?>" min="0" />
						&nbsp;<em><?php esc_html_e( 'Enter a minimum and maximum value for the limit range.', 'woocommerce-product-addons-extra-digital' ); ?></em>
					</div>
				</div>
			</div>
			...
			<div class="wc-pao-row wc-pao-addon-adjust-price-container <?php echo esc_attr( $display_adjust_price ); ?>">
				<label for="wc-pao-addon-adjust-price-<?php echo esc_attr( $loop ); ?>">
					...
					<?php
					esc_html_e( 'Adjust price', 'woocommerce-product-addons-extra-digital' );
					echo wc_help_tip( __( 'Choose how to calculate price: apply a flat fee regardless of quantity, charge per quantity ordered, or charge a percentage of the total', 'woocommerce-product-addons-extra-digital' ) );
					?>
				</label>
				<div class="wc-pao-addon-adjust-price-settings <?php echo esc_attr( $display_adjust_price_settings ); ?>">
					<select id="wc-pao-addon-adjust-price-select-<?php echo esc_attr( $loop ); ?>" name="product_addon_price_type[<?php echo esc_attr( $loop ); ?>]" class="wc-pao-addon-adjust-price-select">
						<option <?php selected( 'flat_fee', $price_type ); ?> value="flat_fee"><?php esc_html_e( 'Flat Fee', 'woocommerce-product-addons-extra-digital' ); ?></option>
						<option <?php selected( 'quantity_based', $price_type ); ?> value="quantity_based"><?php esc_html_e( 'Quantity Based', 'woocommerce-product-addons-extra-digital' ); ?></option>
						<option <?php selected( 'percentage_based', $price_type ); ?> value="percentage_based"><?php esc_html_e( 'Percentage Based', 'woocommerce-product-addons-extra-digital' ); ?></option>
					</select>
